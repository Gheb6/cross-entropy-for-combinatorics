...
Livello di Input: Riceve i dati grezzi dall’esterno.
Livelli Nascosti: Eseguono elaborazioni intermedie sui dati. Possono esserci uno o più livelli nascosti.
Livello di Output: Fornisce il risultato finale dell’elaborazione.
Funzionamento
